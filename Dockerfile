...
ENTRYPOINT /bin/bash -c 'source /opt/ros/kinetic/setup.bash; source /home/ros/catkin_ws/devel/setup.bash; python reasoning_and_learning_framework/src/ralf.py /app/models/mln'
